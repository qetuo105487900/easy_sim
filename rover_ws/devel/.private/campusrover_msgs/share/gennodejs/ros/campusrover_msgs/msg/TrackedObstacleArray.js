...
class TrackedObstacleArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obstacles.forEach((val) => {
      bufferOffset = TrackedObstacle.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrackedObstacleArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.obstacles[i] = TrackedObstacle.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.obstacles.forEach((val) => {
      length += TrackedObstacle.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackedObstacleArray(null);
    ...
    if (msg.obstacles !== undefined) {
      ...
      for (let i = 0; i < resolved.obstacles.length; ++i) {
        resolved.obstacles[i] = TrackedObstacle.Resolve(msg.obstacles[i]);
      }
    }
    else {
      resolved.obstacles = []
...
module.exports = TrackedObstacleArray;
