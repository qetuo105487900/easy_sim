...
"""autogenerated by genpy from campusrover_msgs/TrackedObstacleArray.msg. Do not edit."""
import codecs
import sys
...
class TrackedObstacleArray(genpy.Message):
  _md5sum = "9b4a0e1c63af778bd3ddd8fe92cac32b"
  _type = "campusrover_msgs/TrackedObstacleArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','campusrover_msgs/TrackedObstacle[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackedObstacleArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.obstacles:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_IH().pack(_x.id, _x.label))
        _v3 = val1.pose
        _v4 = _v3.position
        _x = _v4
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = campusrover_msgs.msg.TrackedObstacle()
        _v10 = val1.header
        start = end
        end += 4
        ...
        (_x.id, _x.label,) = _get_struct_IH().unpack(str[start:end])
        _v12 = val1.pose
        _v13 = _v12.position
        _x = _v13
        start = end
