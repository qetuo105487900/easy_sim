...
"""autogenerated by genpy from campusrover_msgs/ImgLabelRequest.msg. Do not edit."""
import codecs
import sys
...
class ImgLabelRequest(genpy.Message):
  _md5sum = "b343faf327da784e080ab24aa33fd5f5"
  _type = "campusrover_msgs/ImgLabelRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """sensor_msgs/Image source_img
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImgLabelRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from campusrover_msgs/ImgLabelResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ImgLabelResponse(genpy.Message):
  _md5sum = "d621a54501775112eaef460e7d5c4ce6"
  _type = "campusrover_msgs/ImgLabelResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vision_msgs/Detection2DArray result
...
"""
  __slots__ = ['result']
  _slot_types = ['vision_msgs/Detection2DArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImgLabelResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.result is None:
        self.result = vision_msgs.msg.Detection2DArray()
    else:
      self.result = vision_msgs.msg.Detection2DArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.detections:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.detections.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class ImgLabel(object):
  _type          = 'campusrover_msgs/ImgLabel'
  _md5sum = '01b5f1e77c12a6c454c2abea9ffd1188'
  _request_class  = ImgLabelRequest
  _response_class = ImgLabelResponse
