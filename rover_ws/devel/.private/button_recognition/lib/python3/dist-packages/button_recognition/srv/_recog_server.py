...
"""autogenerated by genpy from button_recognition/recog_serverRequest.msg. Do not edit."""
import codecs
import sys
...
class recog_serverRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "button_recognition/recog_serverRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(recog_serverRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from button_recognition/recog_serverResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class recog_serverResponse(genpy.Message):
  _md5sum = "12b72b5c7c496ba6c0cf86c357d82144"
  _type = "button_recognition/recog_serverResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """recog_result box
...
string text"""
  __slots__ = ['box']
  _slot_types = ['button_recognition/recog_result']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(recog_serverResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.box is None:
        self.box = button_recognition.msg.recog_result()
    else:
      self.box = button_recognition.msg.recog_result()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.box.data)
      buff.write(_struct_I.pack(length))
      for val1 in self.box.data:
        _x = val1
...
def _get_struct_5i3f():
    ...
    return _struct_5i3f
class recog_server(object):
  _type          = 'button_recognition/recog_server'
  _md5sum = '3e93f1b70ee662ac10c8c863201cbf9c'
  _request_class  = recog_serverRequest
  _response_class = recog_serverResponse
