...
if(modify_scan_pointcloud_CONFIG_INCLUDED)
  return()
endif()
set(modify_scan_pointcloud_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(modify_scan_pointcloud_SOURCE_PREFIX /home/lun/rover_ws/src/campusrover_elevator_3/modify_scan_pointcloud)
  set(modify_scan_pointcloud_DEVEL_PREFIX /home/lun/rover_ws/devel/.private/modify_scan_pointcloud)
  set(modify_scan_pointcloud_INSTALL_PREFIX "")
  set(modify_scan_pointcloud_PREFIX ${modify_scan_pointcloud_DEVEL_PREFIX})
else()
  set(modify_scan_pointcloud_SOURCE_PREFIX "")
  set(modify_scan_pointcloud_DEVEL_PREFIX "")
  set(modify_scan_pointcloud_INSTALL_PREFIX /home/lun/rover_ws/install)
  set(modify_scan_pointcloud_PREFIX ${modify_scan_pointcloud_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'modify_scan_pointcloud' is deprecated")
...
set(modify_scan_pointcloud_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(modify_scan_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${modify_scan_pointcloud_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'modify_scan_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'modify_scan_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lun/rover_ws/src/campusrover_elevator_3/modify_scan_pointcloud/${idir}'.  ${_report}")
    endif()
    _list_append_unique(modify_scan_pointcloud_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND modify_scan_pointcloud_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND modify_scan_pointcloud_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT modify_scan_pointcloud_NUM_DUMMY_TARGETS)
      set(modify_scan_pointcloud_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::modify_scan_pointcloud::wrapped-linker-option${modify_scan_pointcloud_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR modify_scan_pointcloud_NUM_DUMMY_TARGETS "${modify_scan_pointcloud_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::modify_scan_pointcloud::wrapped-linker-option${modify_scan_pointcloud_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND modify_scan_pointcloud_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lun/rover_ws/devel/.private/modify_scan_pointcloud/lib;/home/lun/campusrover_cartographer_ws/devel/lib;/home/lun/jay_ws/devel/lib;/home/lun/rover_ws/devel/lib;/home/lun/robot_arm_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(modify_scan_pointcloud_LIBRARY_DIRS ${lib_path})
      list(APPEND modify_scan_pointcloud_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'modify_scan_pointcloud'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND modify_scan_pointcloud_LIBRARIES ${lib})
    endif()
  endif()
...
set(modify_scan_pointcloud_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${modify_scan_pointcloud_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;std_msgs;sensor_msgs;campusrover_msgs;dynamixel_msgs;nav_msgs;tf;pcl_ros")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 modify_scan_pointcloud_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${modify_scan_pointcloud_dep}_FOUND)
      find_package(${modify_scan_pointcloud_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${modify_scan_pointcloud_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(modify_scan_pointcloud_INCLUDE_DIRS ${${modify_scan_pointcloud_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(modify_scan_pointcloud_LIBRARIES ${modify_scan_pointcloud_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${modify_scan_pointcloud_dep}_LIBRARIES})
  _list_append_deduplicate(modify_scan_pointcloud_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(modify_scan_pointcloud_LIBRARIES ${modify_scan_pointcloud_LIBRARIES})

  _list_append_unique(modify_scan_pointcloud_LIBRARY_DIRS ${${modify_scan_pointcloud_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(modify_scan_pointcloud_EXPORTED_TARGETS ${${modify_scan_pointcloud_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${modify_scan_pointcloud_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
