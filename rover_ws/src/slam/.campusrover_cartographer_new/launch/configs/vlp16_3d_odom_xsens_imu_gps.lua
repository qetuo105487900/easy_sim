...
TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.max_range = 40
TRAJECTORY_BUILDER_3D.low_resolution_adaptive_voxel_filter.max_range = 150.
...
POSE_GRAPH.optimization_problem.huber_scale = 0.1
