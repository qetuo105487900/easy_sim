...
public:
  ...
  ros::Publisher ArmNameTargetPub,PressButtonPlanPub;
  ros::Publisher StringPub;
  ros::Publisher robot_odom_pose_yaw_pub, goal_odom_pose_yaw_pub;  

  ros::ServiceClient Joint1SlopeClient, Joint2SlopeClient, Joint3SlopeClient, NameTargetClient,
      EnableButtonRecognizeClient, EnableButtonTrackingClient, EnableMpcClient, EnableVisualServoClient;
  ...
  // void NameTargetClientCallService(ros::ServiceClient &client,campusrover_msgs::poseture_srv &srv);
};
